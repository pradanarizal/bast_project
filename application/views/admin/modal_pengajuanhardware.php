                    ...
                    <form action="<?php echo site_url() . 'admin/hardware_save'; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="form-grup mt-3">
                                ...
                                <input minlength="10" maxlength="10" type="text" id="noticket" name="noticket" class="form-control" required onkeypress="return event.charCode >= 48 && event.charCode <=57">
                            </div>
                        </div>
                        ...
                        <div class="request">
                            ...
                            <div class="card">
                                <div class="form-grup mt-3">
                                    ...
                                    <input minlength="16" maxlength="16" type="text" id="inputnik" name="inputnik" class="form-control" required onkeypress="return event.charCode >= 48 && event.charCode <=57">
                                </div>
