                        ...
                        <div class="content">
                            <div class="card mb-3">
                                <div class="form-group mt-3">
                                    ...
                                    <input minlength="4" type="text" name="id_receipt" class="form-control" value="<?php echo $data->id_receipt; ?>" hidden>
                                    <input type="text" name="no_tiket" class="form-control" id="inputEmail4" value="<?php echo $data->no_tiket ?>">
                                </div>
                            </div>
                            ...
                            <div class="card giver-content">
                                ...
                                <div class="form-grup mt-3">
                                    ...
                                    <input type="text" id="inputNama" name="inputNama" class="form-control" value="<?php echo $data->nama ?>">
                                </div>
                                <div class="form-grup mt-3">
                                    <label for="inputNik" class="text-dark font-weight-bold">NIK/NIPP</label>
                                    <input type="number" id="inputNik" name="inputNik" class="form-control"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required value="<?php echo $data->nik ?>">
                                </div>
                                <div class="form-check-inline row">
                                    <div class="form-grup mt-3 col-sm">
                                        ...
                                        <input type="text" id="position" name="position" class="form-control" value="<?php echo $data->jabatan ?>" required>
                                    </div>
                                    <div class="form-grup mt-3 col-sm">
                                        <label for="inputNik" class="text-dark font-weight-bold">Unit Division</label>
                                        <input type="text" id="unit_division" name="unit_division" class="form-control" value="<?php echo $data->bagian ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-check-inline row">
                                    <div class="form-grup mt-3 col-sm">
                                        ...
                                        <input type="text" id="itemName" name="itemName" class="form-control" value="<?php echo $data->item ?>" required>
                                    </div>
                                    <div class="form-grup mt-3 col-sm">
                                        <label for="itemID" class="text-dark font-weight-bold">Item ID</label>
                                        <input type="text" name="itemID" class="form-control" value="<?php echo $data->item_id ?>" required>
                                    </div>
                                </div>
                                <div class="form-grup mt-3">
                                    <label for="description" class="text-dark font-weight-bold">Description</label>
                                    <textarea id="description" name="description" class="form-control" cols="30" rows="10"><?php echo $data->description ?></textarea>
                                </div>
                            </div>
