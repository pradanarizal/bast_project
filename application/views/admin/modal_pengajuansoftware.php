                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="no_tiket" class="form-control" id="no_tiket" minlength="10" maxlength="10" required>
                        </div>
                    </div>
                    ...
                    <div class="request">
                        ...
                        <div class="card">
                            <div class="form-grup mt-3">
                                ...
                                <input type="text" id="inputnik" name="inputnik" class="form-control" minlength="16" maxlength="16" required >
                            </div>
