	...
	<div class="row">
		<div class="container-fluid">
			<div class="d-sm-flex align-items-center justify-content-between mb-4 judul-submission">
				<div class="mb-0 text-gray-800">BAST</div>
			</div>
			<div class="card shadow mb-2">
				<div class="card-body">
					<div class="tombol-pengajuan">
						<button class="btn btn-md btn-success mb-3" data-toggle="modal" data-target="#addReceipt"><i class="fas fa-plus fa-sm mr-2"></i>Add New BAST</button>
					</div>
								...
								<tr>
									...
									<td>
										...
										<?php if ($data->nik_admin == "") { ?>
											<a href="<?php echo base_url('admin/add_receiver?idReceipt=') . $data->id_receipt . '&nikAdmin=' . $data->nik_admin ?>">
												<button title="Add Receiver" class="tombol bg-success text-white">
