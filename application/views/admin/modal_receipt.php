				...
				<div class="modal-body" id="signature-pad">
					...
					<form action="<?php echo site_url() . 'admin/receipt_save'; ?>" method="post" enctype="multipart/form-data">
						...
						<div class="card giver-content">
							...
							<div class="form-grup mt-3">
								<label for="itemID" class="text-dark font-weight-bold">Phone Number</label>
								<input type="number" name="phone_number" class="form-control" maxlength="13" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
							</div>
							<div class="form-grup mt-3">
